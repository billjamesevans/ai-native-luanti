    ...
    *,
    ...
    payload = {
        ...
        "summary": {
            ...
            "live_prompt_eval_player_agent_loop_option_selection_checked":
                live_prompt_evidence.get(
            ...
            "live_prompt_eval_natural_pending_edit_checked":
                live_prompt_evidence.get(
                    "agent_prompt_eval_natural_pending_edit_checked"
                ) is True
                or live_prompt_summary.get("natural_pending_edit_checked") is True,
