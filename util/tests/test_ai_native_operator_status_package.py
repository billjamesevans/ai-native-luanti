...
class AIOperatorStatusPackageTests(unittest.TestCase):
    ...
    def test_docs_describe_operator_status_package_boundary(self):
        ...
        self.assertIn("view=tasks", doc)
        self.assertIn("view=task", doc)
        self.assertIn("view=audit", doc)
        self.assertIn("view=rollback", doc)
        self.assertIn("view=imports", doc)
        self.assertIn("ai_native_operator_status_view", doc)
