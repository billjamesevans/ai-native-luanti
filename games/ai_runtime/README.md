...
The base mod also declares the first-party agent capability policy for this clean profile. It grants bounded world, entity, task, and model-adapter capabilities, and excludes privileged operator/import/player-combat grants.
