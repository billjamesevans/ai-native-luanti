...
- Operator task-control command probe: `python3 util/ai_native_operator_task_control_command_probe.py --output local/ai-runtime-operator-task-control-command-result.json --generated-at 2026-06-29T00:00:00Z`
...
- Agent improvement-loop verifier: `python3 util/ai_native_agent_improvement_loop_verify.py --root . --output local/benchmarks/ai-runtime-agent-improvement-loop-result.json --generated-at 2026-06-30T00:00:00Z`
...
- Nova auto-apply live probe: `python3 util/ai_native_nova_auto_apply_live_probe.py --root . --server-bin bin/luantiserver --output local/benchmarks/ai-runtime-nova-auto-apply-live-result.json --generated-at 2026-06-29T00:00:00Z`
- Agent Improvement Loop candidate queue: `python3 util/ai_native_agent_eval_queue.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --request-response-log-gate local/benchmarks/ai-agent-request-response-log-gate.json --nova-agent-log local/logs/nova-agent-requests.jsonl --action-log local/logs/luanti-debug.log --verified-live-probe local/logs/live-probes --output local/benchmarks/ai-agent-eval-candidate-queue.json --generated-at 2026-06-30T00:00:00Z`
- Agent feedback packet: `python3 util/ai_native_agent_feedback_packet.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --prompt "build a bridge" --case-hint stone_bridge_platform --build-kind platform --build-material-name stone --planned-node-writes 12 --route agentic_build_planner --candidate-queue-output local/benchmarks/ai-agent-eval-candidate-queue.json --operator-label-output local/benchmarks/ai-agent-operator-labels.json --case-pack-output local/benchmarks/ai-agent-prompt-eval-case-pack.json --generated-at 2026-06-30T00:00:00Z`
- Agent feedback packet from in-game review: `python3 util/ai_native_agent_feedback_packet.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --action-log local/logs/luanti-debug.log --from-operator-feedback --candidate-queue-output local/benchmarks/ai-agent-eval-candidate-queue.json --operator-label-output local/benchmarks/ai-agent-operator-labels.json --case-pack-output local/benchmarks/ai-agent-prompt-eval-case-pack.json --generated-at 2026-06-30T00:00:00Z`
- Operator-label artifact builder: `python3 util/ai_native_agent_operator_label.py --candidate-queue local/benchmarks/ai-agent-eval-candidate-queue.json --prompt "build a bridge" --case-hint stone_bridge_platform --build-kind platform --build-material-name stone --planned-node-writes 12 --route agentic_build_planner --output local/benchmarks/ai-agent-operator-labels.json --generated-at 2026-06-30T00:00:00Z`
- Operator-labeled eval queue: add `--operator-labels local/benchmarks/ai-agent-operator-labels.json` to promote reviewed unknown build prompts into replayable prompt-eval candidates.
- Agent request/response log gate: `python3 util/ai_native_agent_request_response_log_gate.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --output local/benchmarks/ai-agent-request-response-log-gate.json --generated-at 2026-06-30T00:00:00Z`
- Agents SDK sidecar offline readiness: `python3 util/ai_native_agents_sdk_sidecar_readiness.py --mode offline-smoke`
...
- Agent memory refresh: `python3 util/ai_native_agent_memory_refresh.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --request-response-log-gate local/benchmarks/ai-agent-request-response-log-gate.json --nova-agent-log local/logs/nova-agent-requests.jsonl --action-log local/logs/luanti-debug.log --verified-live-probe local/logs/live-probes --from-operator-feedback --operator-labels local/benchmarks/ai-agent-operator-labels.json --candidate-queue-output local/benchmarks/ai-agent-eval-candidate-queue.json --case-pack-output local/benchmarks/ai-agent-prompt-eval-case-pack.json --generated-at 2026-06-30T00:00:00Z`
- Agent default-gate memory rule: promoted cases remain review-gated unless repeated trusted source kinds satisfy the required agent tool contract; tune the threshold with `--auto-default-gate-min-sources`.
- Agent adapter-contract eval: `python3 util/ai_native_agent_adapter_contract_eval.py --candidate-queue local/benchmarks/ai-agent-eval-candidate-queue.json --output local/benchmarks/ai-agent-adapter-contract-eval.json --endpoint http://127.0.0.1:8766/v1/model-adapter --generated-at 2026-06-30T00:00:00Z`
- Agentic build selection contract: Agents SDK build-planning responses may change the pending preview only through `response.selected_option_id` or `response.tool_decisions.build_option.selected_option_id` matching a bounded candidate from Luanti; healthy live runs must expose an accepted tool-contract source, `required_tool_calls_satisfied = true`, and a `select_build_option` tool trace, while generic fallback sources feed the eval/improvement loop with high-priority adapter-contract evidence.
