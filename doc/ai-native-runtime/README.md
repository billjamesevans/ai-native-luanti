...
- Agent memory refresh: `python3 util/ai_native_agent_memory_refresh.py --agents-sdk-log local/logs/agents-sdk-model-adapter.jsonl --nova-agent-log local/logs/nova-agent-requests.jsonl --action-log local/logs/luanti-debug.log --from-operator-feedback --operator-labels local/benchmarks/ai-agent-operator-labels.json --candidate-queue-output local/benchmarks/ai-agent-eval-candidate-queue.json --case-pack-output local/benchmarks/ai-agent-prompt-eval-case-pack.json --generated-at 2026-06-30T00:00:00Z`
