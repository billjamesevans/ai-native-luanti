...
Do not promote either lane unless the clean-profile summary has `overall_status=pass`, `server_step_workload.workload_status=pass`, `server_step_workload.failed_sample_count=0`, `player_load_tick_probe.probe_status=pass`, `probe_kind=headless_client_load`, `headless_player_supported=true`, `synthetic_player_count>0`, and connected synthetic players equal attempted synthetic players.
